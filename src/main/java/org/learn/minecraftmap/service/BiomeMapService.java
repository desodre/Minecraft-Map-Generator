...
public class BiomeMapService {
     ...
     */
    public byte[] generateTileImage(long seed, String mcVersion, int dimension, int zoom, int tx, int ty) throws IOException {
        long start = System.currentTimeMillis();
        logger.info("Starting PNG tile rendering for seed={}, version={}, dimension={}, zoom={}, tx={}, ty={}", seed, mcVersion, dimension, zoom, tx, ty);

        int tileSize = 256;
        BiomeInfo[][] biomeGrid = biomeGenerator.getBiomeTile(seed, mcVersion, dimension, zoom, tx, ty, tileSize);
